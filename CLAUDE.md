...
- Hauswasser = Hauptwasser - Gartenwasser (calculated by user via utility meters or templates)

## Key Files
- custom_components/water_meter/__init__.py — Integration setup
- custom_components/water_meter/config_flow.py — Config flow + options flow (add/remove meters)
- custom_components/water_meter/sensor.py — Counter sensor (L) + cubic meter sensor (m³), impulse listener
...
- Options flow: add/remove meters
